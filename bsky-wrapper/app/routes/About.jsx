...
const About = () => {
    ...
    const about = [
        ...
        (<>For additional information, and up-to-date progress on v2 of the Blue Wrapper, you can view its README on <a href="https://github.com/Amazingca/BSKY-Wrapper/blob/main/README.md" target="_blank">Github</a>.</>),
        "## Maintainers",
        (<a href="https://amazingca.dev">autumn.bsky.gay</a>)
    ];
